...
void NewFunction(std::vector<DrinkItem>& drinks)
{
    //DrinkItem drink1("紅茶", "大杯", 60);
    //drinks.push_back(drink1);

    drinks.push_back(DrinkItem("奶茶", "大杯", 60));
    drinks.push_back(DrinkItem("奶茶", "中杯", 40));
    drinks.push_back(DrinkItem("紅茶", "大杯", 30));
    drinks.push_back(DrinkItem("紅茶", "中杯", 20));
    drinks.push_back(DrinkItem("綠茶", "大杯", 30));
    drinks.push_back(DrinkItem("綠茶", "中杯", 20));
    drinks.push_back(DrinkItem("麥茶", "大杯", 30));
    drinks.push_back(DrinkItem("麥茶", "中杯", 20));
}
